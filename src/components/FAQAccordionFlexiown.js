...
const FAQAccordionFlexiown = () => {
    ...
    return (
        <div className="w-full flex flex-col lg:flex-row justify-between mx-auto mt-8 py-0 md:py-4 gap-6 lg:gap-[15vw] container">
            <h2 className="text-[24px] sm:text-[30px] md:text-[40px] text-left font-bold md:mb-4 text-[#343637] sm:max-w-[200px] leading-[1.2] sm:leading-10">Got Questions About <br className="block sm:hidden"/> Our FlexiOwn Plan?</h2>
