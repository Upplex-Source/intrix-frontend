                ...
                <div>
                    ...
                    <ul className="p-4 space-y-4 text-lg font-medium">
                        ...
                        <li>
                            <Link 
                                ...
                                className="text-[20px]">Payment Plans</Link>
                        </li>
                        <li>
                            <Link 
                                href={'/insights'} 
                                ...
                                className="text-[20px]">Insights</Link>
                        </li>
                        <li>
                            <Link 
                                href={'/sustainability'} 
                                ...
                                className="text-[20px]">Sustainability</Link>
                        </li>
                        <li className="border-b border-white pb-4">
                            <Link 
                                ...
                                className="text-[20px]">Discover INTRIX</Link>
                        </li>
                        <li>
                            <Link 
                                href={'/support'} 
                                ...
                                className="text-[20px]">Support</Link>
                        </li>
                        <li>
                            <Link 
                                href={'find-a-store'} 
                                ...
                                className="text-[20px]">Find A Store</Link>
                        </li>
                        <li>
                            <Link 
                                href={'/payment-plan'} 
                                ...
                                className="text-[20px]">FlexiOwn Plan</Link>
                        </li>
                        <li>
                            <Link 
                                href={'events'} 
                                ...
                                className="text-[20px]">Events</Link>
                        </li>
                        <li>
                            <Link 
                                href={'/faq'} 
                        ...
                        <li className="border-b border-white pb-4">
                            <Link 
                                ...
                                className="text-[20px]">For Business</Link>
                        </li>
                    </ul>
                </div>
                    {/* Social Icons */}
                    <div className="px-4 py-6">
                        ...
                        <div className="flex space-x-6">
                            <Link href={'#'} className="text-[23px]"><FontAwesomeIcon icon={faSquareInstagram} /></Link>
                            <Link href={'#'} className="text-[23px]"><FontAwesomeIcon icon={faXTwitter} /></Link>
                            <Link href={'#'} className="text-[23px]"><FontAwesomeIcon icon={faFacebookF} /></Link>
                            <Link href={'#'} className="text-[23px]"><FontAwesomeIcon icon={faYoutube} /></Link>
                            <Link href={'#'} className="text-[23px]"><FontAwesomeIcon icon={faTiktok} /></Link>
                        </div>
                    </div>
                </div>

            {/* Right Menu (Submenu) */}
                <div className={`fixed inset-0 bg-[#F79932] text-white z-50 transform ${
                    ...
                    <div className="p-4 space-y-4 mt-6">
                        ...
                        <ul className="space-y-2">
                            <li><Link href="/explore" onClick={() => {setIsLeftMenuOpen(false);setIsRightMenuOpen(false);}} className="text-[16px]">Overview</Link></li>
                            <li><Link href="/product" onClick={() => {setIsLeftMenuOpen(false);setIsRightMenuOpen(false);}} className="text-[16px]">INTRIX One Tap 5-in-1</Link></li>
                            <li><Link href="/product" onClick={() => {setIsLeftMenuOpen(false);setIsRightMenuOpen(false);}} className="text-[16px]">INTRIX One Tap 4-in-1</Link></li>
                            <li><Link href="/product" onClick={() => {setIsLeftMenuOpen(false);setIsRightMenuOpen(false);}} className="text-[16px]">INTRIX One Tap 2-in-1</Link></li>
                            <li><Link href="/product" onClick={() => {setIsLeftMenuOpen(false);setIsRightMenuOpen(false);}} className="text-[16px]">INTRIX One Tap Lite</Link></li>
                        </ul>

                        <h3 className="text-[20px] font-bold border-b border-[#fff] pb-3">Accessories</h3>
                        <ul className="space-y-2">
                        <li><Link href="/product/filter" onClick={() => {setIsLeftMenuOpen(false);setIsRightMenuOpen(false);}} className="text-[16px]">INTRIX All-in-One Filter</Link></li>
                        <li><Link href="/product/font" onClick={() => {setIsLeftMenuOpen(false);setIsRightMenuOpen(false);}} className="text-[16px]">INTRIX Font</Link></li>
                        </ul>
                    </div>
                </div>
        </div>
