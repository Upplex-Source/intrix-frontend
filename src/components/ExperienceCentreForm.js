...
export default function ExperienceCentreForm() {
    ...
    const shops = [
        ...
        {
            name: "Bumhan Sanitary Wares Sdn Bhd",
            location: "No.4, & 6, Jalan Anggerik Vanilla R 31/R, Kota Kemuning, 40460 Shah Alam, Selangor, Malaysia.",
        },
        ...
        {
            name: "Rowenda Malaysia",
            location: "Bistari DE Kota, B-13A, Jalan Teknologi 3/9, Kota Damansara, 47810 Petaling Jaya, Selangor, Malaysia.",
        },
        ...
        {
            name: "Signature Flagship Store",
            location: "Lot 24, Jalan Teknologi Taman Sains Selangor 1, PJU 5 Kota Damansara, 47810 Petaling Jaya, Selangor, Malaysia.",
        },
        {
            name: "Signature IPC",
            location: "L1.11 & L1.12, IPC Shopping Centre, No.2 Jalan PJU 7/2, Mutiara Damansara, 47800 Petaling Jaya, Selangor, Malaysia.",
        },
        {
            name: "Signature One Utama",
            location: "Lot S-106 Old Wing, 2nd floor, One Utama Megamall, Lebuh Bandar Utama, Bandar Utama, 47800 Petaling Jaya, Selangor, Malaysia.",
        },
        ...
        {
            name: "Signature Sunway Geo",
            location: "E1-03-07, Level 3, Block E1, Sunway Geo, Jalan Lagoon Selatan, Sunway South Quay, 47500 Bandar Sunway, Subang Jaya, Malaysia.",
        },
        ...
        {
            name: "Urbanez (Kota Damansara)",
            location: "No.36-2, 1st Floor, Jalan PJU 5/8 Dataran Sunway, Kota Damansara, 47810 Petaling Jaya, Selangor, Malaysia.",
        },
    ];
