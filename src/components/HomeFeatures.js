    ...
    return (
        <div className="flex items-center flex-col md:flex-row overflow-y-hidden h-full w-full">
            ...
            <div className="pl-12 [@media(max-height:700px)]:pl-12 [@media(max-height:700px)]:pr-4 xl:pl-24 w-full [@media(max-height:700px)]:w-2/3 md:w-1/2">
                ...
                <div className="font-[Montserrat-Regular] text-black [@media(min-height:701px)]:max-w-[700px] [@media(max-height:812px)]:mb-3 [@media(max-height:700px)]:!max-w-[100%] mb-8 text-[14px] [@media(max-height:812px)]:text-[14px] md:text-[16px]">
                ...
                <div className="text-[#000] space-y-6 [@media(max-height:812px)]:space-y-2 md:space-y-4 w-fit [@media(max-height:812px)]:mx-0 mx-[10%] [@media(max-height:700px)]:w-full">
                    <div className="flex items-center gap-x-6 xl:gap-x-8 max-w-[600px] mx-auto [@media(max-height:700px)]:!max-w-[100%]">
                        <Image alt="microbes" className="block [@media(max-height:812px)]:max-w-[35px] max-w-[55px]" src={"/product/icon.png"} width={240} height={240} />
                        <div className="">
                            <div className="font-bold text-[16px] [@media(max-height:812px)]:text-[16px] md:text-[20px]">Removes 99.99% Microbes Down to Micron</div>
                            <div className="font-[Montserrat-Regular] text-[14px] [@media(max-height:812px)]:text-[14px] md:text-[16px]">
                            Removes bacteria, algae and some viruses while preserving natural minerals.
                            </div>
                        </div>
                    </div>
                    <div className="flex items-center gap-x-6 xl:gap-x-8 max-w-[600px] mx-auto [@media(max-height:700px)]:!max-w-[100%]">
                        <Image alt="hot and cold water" className="block [@media(max-height:812px)]:max-w-[35px] max-w-[55px]" src={"/product/heat_cold.png"} width={240} height={240} />
                        <div className="">
                            <div className="font-bold text-[16px] [@media(max-height:812px)]:text-[16px] md:text-[20px]">Instant Purified Hot &amp; Chilled Water</div>
                            <div className="font-[Montserrat-Regular] text-[14px] [@media(max-height:812px)]:text-[14px] md:text-[16px]">
                    ...
                    <div className="flex items-center gap-x-6 xl:gap-x-8 max-w-[600px] mx-auto [@media(max-height:700px)]:!max-w-[100%]">
                        <Image alt="space" className="block [@media(max-height:812px)]:max-w-[35px] max-w-[55px]" src={"/product/space.png"} width={240} height={240} />
                        <div className="">
                            <div className="font-bold text-[16px] [@media(max-height:812px)]:text-[16px] md:text-[20px]">Space Saving</div>
                            <div className="font-[Montserrat-Regular] text-[14px] [@media(max-height:812px)]:text-[14px] md:text-[16px]">
                    ...
                    <div className="flex items-center gap-x-6 xl:gap-x-8 max-w-[600px] mx-auto [@media(max-height:700px)]:!max-w-[100%]">
                        <Image alt="isolation" className="block [@media(max-height:812px)]:max-w-[35px] max-w-[55px]" src={"/product/isolation.png"} width={240} height={240} />
                        <div className="">
                            <div className="font-bold text-[16px] [@media(max-height:812px)]:text-[16px] md:text-[20px]">Safety Child Lock</div>
                            <div className="font-[Montserrat-Regular] text-[14px] [@media(max-height:812px)]:text-[14px] md:text-[16px]">
