...
const ExploreOurTabs = () => {
    return (
        <div className="container mx-auto">
            <div className="text-[#343637] text-[40px] text-center font-bold mb-4">Explore Our One Tap Series</div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-[#421908] bg-white rounded-lg px-6 pb-6">
                    ...
                    <div className="text-[14px] md:text-[16px]">INTRIX One Tap 5-in-1</div>
                    <div className="text-[#421908] text-[18px] md:text-[24px] font-bold">RM 7,500.00</div>
                    <div className="text-[12px] mb-6 h-[50px]">
                ...
                <div className="text-[#421908] bg-white rounded-lg px-6 pb-6">
                    ...
                    <div className="text-[14px] md:text-[16px]">INTRIX One Tap 4-in-1</div>
                    <div className="text-[#421908] text-[18px] md:text-[24px] font-bold">RM 5,200.00</div>
                    <div className="text-[12px] mb-6 h-[50px]">
                ...
                <div className="text-[#421908] bg-white rounded-lg px-6 pb-6">
                    ...
                    <div className="text-[14px] md:text-[16px]">INTRIX One Tap 2-in-1</div>
                    <div className="text-[#421908] text-[18px] md:text-[24px] font-bold">RM 4,500.00</div>
                    <div className="text-[12px] mb-6 h-[50px]">
                ...
                <div className="text-[#421908] bg-white rounded-lg px-6 pb-6">
                    ...
                    <div className="text-[14px] md:text-[16px]">INTRIX One Tap Lite</div>
                    <div className="text-[#421908] text-[18px] md:text-[24px] font-bold">RM 3,988.00</div>
                    <div className="text-[12px] mb-6 h-[50px]">
