...
const ProductFeatures = () => {
    return (
        <div className="overflow-hidden flex items-center flex-col md:flex-row min-[1441px]:max-h-[100%] lg:max-h-[100vh]">
            <Image alt="Tumbler" className="w-full md:w-2/5 [@media(max-height:700px)]:w-[500px] min-[1441px]:w-[650px] min-[1641px]:w-1/2 max-[1000px]:max-h-[700px] md:h-[100vh] object-cover" src={"/product/tumbler.svg"} width={1200} height={860} />
            <div className="p-6 p-4 md:p-12 xl:p-24 w-full w-full md:3/5 lg:w-1/2">
                ...
                <div className="text-[#000] space-y-6 space-y-2 md:space-y-4 w-fit mx-0 mx-auto">
                    ...
                    <div className="flex items-center gap-x-6 xl:gap-x-8 max-w-[600px] mx-auto">
                        ...
                        <div className="">
                            <div className="font-bold text-[16px] text-[16px] min-[1441px]:text-[20px]">Instant Purified Hot & Chilled Water</div>
                            <div className="font-[Montserrat-Regular] text-[14px] min-[1441px]:text-[16px] leading-[1.2]">
