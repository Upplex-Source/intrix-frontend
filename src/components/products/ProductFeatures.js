...
const ProductFeatures = () => {
    return (
        <div className="overflow-hidden flex items-center flex-col md:flex-row min-[1441px]:max-h-[100%] lg:max-h-[100vh]">
            <Image alt="Tumbler" className="w-full md:w-2/5 [@media(max-height:700px)]:w-[500px] min-[1441px]:w-[650px] min-[1641px]:w-1/2" src={"/product/tumbler.svg"} width={1200} height={860} />
