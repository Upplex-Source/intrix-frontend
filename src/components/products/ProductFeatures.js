...
const ProductFeatures = () => {
    return (
        <div className="flex items-center flex-col md:flex-row">
            <Image alt="Tumbler" className="w-full w-1/4 md:w-1/2 max-[1000px]:max-h-[700px] object-cover" src={"/product/tumbler.svg"} width={1200} height={860} />
            <div className="p-6 p-4 md:p-12 xl:p-24 w-full w-full md:w-1/2">
                ...
                <div className="text-[20px] text-[20px] md:text-[30px] text-[#343637] font-[Mulish-Bold] leading-[1.2] mb-4">
                    Hassle-Free Hydration
                    <br /> With A Design That Delivers.
                </div>
                <div className="font-[Montserrat-Regular] text-black max-w-[700px] mb-3 mb-8 text-[14px] text-[14px] md:text-[16px]">
                ...
                <div className="text-[#000] space-y-6 space-y-2 md:space-y-4 w-fit mx-0 mx-auto">
                    <div className="flex items-center gap-x-6 xl:gap-x-8 max-w-[600px] mx-auto">
                        <Image alt="microbes" className="block max-w-[35px] max-w-[55px]" src={"/product/icon.png"} width={240} height={240} />
                        <div className="">
                            <div className="font-bold text-[16px] text-[16px] md:text-[20px]">Removes 99.99% microbes</div>
                    ...
                    <div className="flex items-center gap-x-6 xl:gap-x-8 max-w-[600px] mx-auto">
                        <Image alt="space" className="block max-w-[35px] max-w-[55px]" src={"/product/space.png"} width={240} height={240} />
                        <div className="">
                            <div className="font-bold text-[16px] text-[16px] md:text-[20px]">Space Saving</div>
                            <div className="font-[Montserrat-Regular] text-[14px] text-[14px] md:text-[16px]">
                    ...
                    <div className="flex items-center gap-x-6 xl:gap-x-8 max-w-[600px] mx-auto">
                        <Image alt="isolation" className="block max-w-[35px] max-w-[55px]" src={"/product/isolation.png"} width={240} height={240} />
                        <div className="">
                            <div className="font-bold text-[16px] text-[16px] md:text-[20px]">Safety Child Lock</div>
                            <div className="font-[Montserrat-Regular] text-[14px] text-[14px] md:text-[16px]">
