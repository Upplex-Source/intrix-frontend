    ...
    return (
        <div className="bg-black text-white p-4">
            ...
            {cartItemList?.cart_metas?.map((cartItem) => (
                <div key={cartItem.id} className="grid grid-cols-5 my-2 py-4 border-b border-white">
                    ...
                    <div className="text-right text-[#ECECED] text-[16px] flex items-center justify-end">
                        <div>
                            MYR <br />
                            <span className="text-[18px]">{cartItem.product.price}</span>
                        </div>
                    </div>
            ...
            {cartItemList?.add_on_metas?.map((addOnItem) => (
                <div key={addOnItem.id} className="grid grid-cols-5 my-2 py-4 border-b border-white">
                    <div className="flex items-center gap-x-4 col-span-2">
                        <div className="bg-white flex items-center justify-center">
                            <Image
                    ...
                    <div className="flex items-center justify-center">
                        <div className="flex items-center gap-x-2 justify-center px-4 py-1 border border-white rounded-lg">
                            ...
                            <span className="mx-2">{addOnItem.quantity}</span>
                    ...
                    <div className="text-right text-[#ECECED] text-[16px] flex items-center justify-end">
                        <div>
                            MYR <br />
                            <span className="text-[18px]">{addOnItem.add_on.price}</span>
                        </div>
                    </div>
                    <div className="text-right text-[#ECECED] text-[16px] font-bold flex items-center justify-end">
                        <div>
                            MYR <br />
                            <span className="text-[18px]">{addOnItem.subtotal}</span>
                        </div>
                    </div>
                </div>
            ))}
            {cartItemList?.free_gift && (
                <div key={cartItemList?.free_gift.id} className="grid grid-cols-5 my-2 py-4 border-b border-white">
                    <div className="flex items-center gap-x-4 col-span-2">
                        <div className="bg-white flex items-center justify-center">
                            <Image
