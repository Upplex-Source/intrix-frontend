...
const ComparisonTable = () => {
  return (
    <>
      <h3 className="px-4 text-[24px] md:text-[30px] min-[1441px]:text-[40px] font-bold text-[#343637] text-center">Which One Is <br className="block sm:hidden"/> The One Tap For You?</h3>
      <div className="overflow-x-auto ">
        <div className="mt-6 min-w-[1000px] w-full pl-4">
          ...
          <div className="grid grid-cols-4">
            <div className="font-[Montserrat-Bold] text-[14px] text-[#272221] font-bold flex items-center pr-2">DISPLAY</div>
          ...
          <div className="grid grid-cols-4 border-t border-[#421908]">
            <div className="font-[Montserrat-Bold] text-[14px] text-[#272221] font-bold flex items-center pr-2">POWER RATING</div>
          ...
          <div className="grid grid-cols-4 border-t border-[#421908]">
            <div className="font-[Montserrat-Bold] text-[14px] text-[#272221] font-bold flex items-center pr-2">CHILLED WATER TEMPERATURE</div>
          ...
          <div className="grid grid-cols-4 border-t border-[#421908]">
            <div className="font-[Montserrat-Bold] text-[14px] text-[#272221] font-bold flex items-center pr-2">HOT WATER TEMPERATURE</div>
          ...
          <div className="grid grid-cols-4 border-t border-[#421908]">
            <div className="font-[Montserrat-Bold] text-[14px] text-[#272221] font-bold flex items-center pr-2">CHILLED WATER OUTPUT / HOUR (167ml/cup)</div>
          ...
          <div className="grid grid-cols-4 border-t border-[#421908]">
            <div className="font-[Montserrat-Bold] text-[14px] text-[#272221] font-bold flex items-center pr-2">HOT WATER OUTPUT / HOUR (167ml/cup) </div>
          ...
          <div className="grid grid-cols-4 border-t border-[#421908]">
            <div className="font-[Montserrat-Bold] text-[14px] text-[#272221] font-bold flex items-center pr-2">ECO SMART TIMER CONTROL</div>
          ...
          <div className="grid grid-cols-4 border-t border-[#421908]">
            <div className="font-[Montserrat-Bold] text-[14px] text-[#272221] font-bold flex items-center pr-2">COLOUR SELECTION</div>
          ...
          <div className="grid grid-cols-4 border-t border-[#421908]">
            <div className="font-[Montserrat-Bold] text-[14px] text-[#272221] font-bold flex items-center pr-2">HEATING ELEMENT MATERIAL</div>
          ...
          <div className="grid grid-cols-4 border-t border-b border-[#421908]">
            <div className="font-[Montserrat-Bold] text-[14px] text-[#272221] font-bold flex items-center pr-2">FILTRATION METHOD</div>
