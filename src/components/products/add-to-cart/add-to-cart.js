        ...
        <div id="cart-wrapper">
            ...
            <div className="container mx-auto my-6 flex items-center justify-center gap-x-24">
                <div class="flex items-center gap-x-4">
                    <div class="w-[42px] h-[42px] flex items-center justify-center rounded-full bg-[#F79932] text-white font-bold">
                    1
                    </div>
                ...
                <div class="flex items-center gap-x-4 opacity-50">
                    <div class="w-[42px] h-[42px] flex items-center justify-center rounded-full bg-[#343637] text-[#646669] font-bold">
                    2
                    </div>
                ...
                <div className="bg-white text-[#141718] px-4 py-6 rounded-lg">
                    ...
                    <div>
                        ...
                        <div className="mb-4 text-[14px]">
                            <p className="mb-6">With every purchase of 1 x INTRIX One Tap model.<br/>Choose ONE only:</p>
                            {freeItems.map((item) => (
                                <div key={item.id} className="flex items-center border rounded-lg overflow-hidden mb-4">
                                <Image
                                    src={item.image}
                                    alt={item.name}
                                    className="min-w-[140px] w-[30%]"
                                    width={200}
                                    height={300}
                                />
                                <div className="flex flex-col justify-center p-4 w-full">
                                    ...
                                    <span className="text-[16px]">
                                        {selectedItem === item.id ? "Added To Cart" : "Add To Cart"}
                                    </span>
                                    <Image
                                        src={
                                        selectedItem === item.id
                                            ? "/cart/arrow-right-selected.png"
                                            : "/cart/arrow-right.png"
                                        }
                                        alt="arrow"
                                        width={20}
                                        height={20}
                    ...
                    <div className="mb-12 relative flex items-center">
                        ...
                        <button type="button" className="border-[0] outline-none text-center text-[#141718] absolute font-bold right-4">Apply</button>
                    </div>
