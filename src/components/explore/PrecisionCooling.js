...
const PrecisionCooling = () => {
    return (
        <div className="w-full mx-auto relative">
            <Image
                src="/explore/Artic3-desktop.png" // Replace with the image URL or leave empty for now
            ...
            />
            <Image
                src="/explore/Artic3-mobile.png" // Replace with the image URL or leave empty for now
                alt="Intrix Experience Centre"
            ...
            <div className="w-full absolute inset-y-0 left-0">
                <div className="min-[1600px]:container min-[1600px]:mx-auto flex flex-col py-6 px-4 lg:py-12 min-[1280px]:px-24 md:justify-center leading-[1.2] text-white w-full md:w-1/2 lg:w-2/3">
