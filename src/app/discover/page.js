                        ...
                        <div className="relative min-[1280px]:min-h-[900px] min-[1600px]:min-h-[80vh] flex items-center container mx-auto">
                            <div className="absolute left-0 top-0">
                                <p className="max-w-[380px] text-[20px] mb-6">
                                    Here at INTRIX, we&apos;re a team of innovative engineers dedicated to uncovering and solving needs you
                            ...
                            <div className="max-w-[380px] absolute right-0 bottom-[15vh]">
                                <p className="text-[20px]">
                                    With 19 patents and a global portfolio of top clients, we&apos;re passionate about disrupting the norms and
                                    tackling day-to-day challenges for a better, more efficient world.
                                </p>
                            </div>
                        </div>
                    </div>
