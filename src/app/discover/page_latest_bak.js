...
function Page() {
    ...
    useEffect(() => {
        ...
        function gotoPanel(index, isScrollingDown) {
            animating = true;
            hasFirstExit = index <= 0 ? false : true;
                ...
                <div className="panel mx-auto px-4 py-4 [@media(min-height:800px)]:py-12">
                    <div className="mx-auto w-fit px-4 pb-8 [@media(min-height:800px)]:pb-4">
                        ...
                        <p className="text-[16px] [@media(max-height:800px)]:text-[16px] md:text-[20px] text-center max-w-[800px] mx-auto">
                            We see undiscovered needs as valuable yet unsolved issues, missed opportunities or utilities that have never been
                            expressed before because people do not know that they need them until they experience them
                        </p>
                    </div>
                    <div className="relative discover_needs min-[1280px]:min-h-[900px] min-[1600px]:min-h-[80vh] flex items-center container mx-auto">
                        <div className="absolute left-0 top-0">
                            <p className="max-w-[380px] [@media(max-height:800px)]:text-[14px] text-[20px] [@media(max-height:800px)]:mb-2 mb-6">
                                Here at INTRIX, we&apos;re a team of innovative engineers dedicated to uncovering and solving needs you didn&apos;t
                                even know you had.
                            </p>
                            <p className="[@media(max-height:700px)]:max-w-[400px] max-w-[300px] [@media(max-height:800px)]:text-[14px] text-[20px]">
                                Since our start in 2003 as experts in thermal and hydro technology, we&apos;ve shifted focus to HVAC, renewable
                                energy, and water purification—industries where we make everyday life simpler and smarter.{" "}
                            </p>
                        </div>
                    ...
                    <div className="flex items-start min-[1700px]:items-center pb-24 md:flex-row flex-col-reverse w-full h-full">
                        <div className="w-full md:w-1/2 flex flex-col items-center justify-center px-4 md:px-12 mt-6 md:mt-0">
                            <div className="mx-auto max-w-[800px] w-full pt-4">
                                <h2 className="text-[24px] md:text-[40px] font-[Mulish-Bold] leading-[1.2] mb-12 [@media(max-height:800px)]:mb-4 w-full">
                                    Our Values
                                </h2>
                                <div className=" [@media(max-height:800px)]:hidden block">
                                    {contentData.map((item, index) => (
                                        <div className="mb-4 [@media(min-height:800px)]:mb-10" key={index}>
                                            <h2 className="text-[16px] md:text-[20px] [@media(max-height:800px)]:text-[16px] font-[Mulish-Bold] leading-[1.2] mb-2">
                                                {item.title}
                                            </h2>
                                            <p className="font-[Montserrat-Regular] text-[14px] md:text-[20px] [@media(max-height:800px)]:text-[16px]">
                                                {item.description}
                                            </p>
                                        </div>
                                    ))}
