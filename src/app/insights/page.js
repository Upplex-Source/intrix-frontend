...
const cardData = [
  {
    ...
    description: "<p>Horem ipsum dolor sit amet, consectetur adipiscing elit. Nunc vulputate libero et velit interdum, ac aliquet odio mattis...</p>",
    min: "5",
    tag: "Blogs",
    link: "#",
  },
        ...
        <>
          <div className="text-center mx-auto mb-4 h-[75vh] sm:h-[850px] lg:h-[700px] min-[1441px]:h-[900px] insight_bg flex items-center">
            ...
            <div className="container mx-auto absolute px-4 left-0 right-0 md:mt-[-120px] md:top-[unset] top-[20px]">
              ...
              <h1 className="text-white text-[24px] md:text-[30px] xl:text-[40px] font-[Mulish-Regular] font-bold md:font-[Mulish-Black] text-left leading-[1.2]">Redefining <br/> Water Purification <br/> Through Innovation</h1>
            </div>
          </div>
          
          <div className="my-12 md:my-24 container mx-auto px-0 z-[2] relative">
            <p className="mb-12 text-center font-[Montserrat-Regular] text-[20px] text-[#292929] max-w-[650px] mx-auto leading-[1.2]">Welcome to INTRIX Insights – your one-stop hub for blogs, inspiration, practical how-tos, and expert advice on all things home innovation and sustainable solutions.</p>
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              <div className="w-full">
                <h2 className="text-[#292929] text-[32px] mb-6">Latest</h2>
                <InsightCards cards={cardData} />
              </div>
              <div>
                <h2 className="text-[#292929] text-[32px] mb-6">Trending</h2>
                <div className="flex flex-col gap-y-6">
                  <InsightTrendingCards cards={cardData2} />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href={"#"} className="rounded-full bg-[#292929] text-[15px] text-center px-6 py-2 hover:text-[#292929] hover:bg-white transition border-[#292929] text-white border mb-6">Load more</Link>
            </div>
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 justify-between mb-12">
              <InsightCards cards={cardData3} />
            </div>
          </div>
        </>
    );
