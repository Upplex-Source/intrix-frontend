                        ...
                        <div className="label-wrapper">
                            <div className="label">
                                <div className="font-[Mulish-Black] [@media(max-height:800px)]:text-[24px] text-[40px] leading-[1.2] text-[#525456]">
                                    Endless
                                    <br className="[@media(max-height:800px)]:hidden" /> Possibilities
                                    <br /> of the INTRIX
                                ...
                                <div className="bullet-wrapper">
                                    <div className="bullet-item">
                                        <Image src={eco} className="[@media(max-height:800px)]:w-[30px]" alt="" />
                                        <div className="[@media(max-height:800px)]:text-[16px] text-[24px] text-[#343637]">80% Energy Saving*</div>
                                    </div>
                                    <div className="bullet-item">
                                        <Image src={recycle} className="[@media(max-height:800px)]:w-[30px]" alt="" />
                                        <div className="[@media(max-height:800px)]:text-[16px] text-[24px] text-[#343637">95% Recyclable*</div>
                                    </div>
                                    <div className="bullet-item">
                        ...
                        <div className="content-wrapper">
                            <div className="list">
                                <div className="list-item">
                                    ...
                                    <div className="list-label [@media(max-height:800px)]:!text-[14px]">Blanching</div>
                                </div>
                                <div className="list-item">
                                    <Image alt="" className="list-img" src={boiling} />
                                    <div className="list-label [@media(max-height:800px)]:!text-[14px]">Boiling</div>
                                </div>
                                <div className="list-item">
                                    <Image alt="" className="list-img" src={poaching} />
                                    <div className="list-label [@media(max-height:800px)]:!text-[14px]">Poaching</div>
                                </div>
                                <div className="list-item">
                                ...
                                <div className="list-item">
                                    ...
                                    <div className="list-label [@media(max-height:800px)]:!text-[14px]">Sterilising</div>
                                </div>
                            </div>
                            <div className="list desc">
                                ...
                                <div className="list-desc-wrapper-2">
                                    ...
                                    <div className="list-desc">
                                        ...
                                        <br className="[@media(max-height:800px)]:hidden" /> water, providing you peace of mind and allowing you
                                        <br className="[@media(max-height:800px)]:hidden" /> to focus on what truly matters with every sip.
                                    </div>
                                </div>
                                <span className="vertical-line" />
                                <div className="list-desc-wrapper-2">
                                    ...
                                    <div className="list-desc">
                                        ...
                                        <br className="[@media(max-height:800px)]:hidden" /> integrates into your modern kitchen. Effortlessly easy
                                        <br className="[@media(max-height:800px)]:hidden" /> to use and safe for all.
                                    </div>
                                </div>
                                <span className="vertical-line" />
                                <div className="list-desc-wrapper-2">
