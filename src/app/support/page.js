                ...
                <>
                    ...
                    <div className="container mx-auto flex flex-col md:flex-row gap-8 md:gap-6 justify-between mb-12 md:mb-24 px-0 sm:px-4">
                        <div className="w-full md:w-1/3">
                            <Image
                                ...
                                src={"/support/image.png?v=1.1"}
                                width={500}
                                height={500}
                            />
                            <h4 className="text-[20px] font-bold text-black my-4 leading-[1.1] px-4 sm:px-0">Ample Space Below Kitchen Sink</h4>
                        ...
                        <div className="w-full md:w-1/3">
                            <Image
                                ...
                                height={500}
                            />
                            <h4 className="text-[20px] font-bold text-black my-4 leading-[1.1] px-4 sm:px-0">13A Plug Point</h4>
                            <div className="text-[16px] text-black font-[Montserrat-Regular] leading-[1.2] px-4 sm:px-0">
                        ...
                        <div className="w-full md:w-1/3">
                            <Image
                                ...
                                height={500}
                            />
                            <h4 className="text-[20px] font-bold text-black my-4 leading-[1.1] px-4 sm:px-0">One Tap, Many Tops</h4>
                            <div className="text-[16px] text-black font-[Montserrat-Regular] leading-[1.2] px-4 sm:px-0">
                                <p className="mb-4">
                    ...
                    <div className="container mx-auto flex flex-col md:flex-row gap-8 md:gap-6 justify-between mb-24 px-0 sm:px-4">
                        <div className="w-full md:w-1/3">
                            <Image
                                alt="delivery"
                                className="block object-cover w-full lg:max-h-[350px]"
                                src={"/support/team.webp"}
                                width={500}
                                height={500}
                            />
                            <h4 className="text-[20px] font-bold text-black my-4 leading-[1.1] px-4 sm:px-0">INTRIX Certified Technician Team</h4>
                            <div className="text-[16px] text-black font-[Montserrat-Regular] leading-[1.2] px-4 sm:px-0">
                                <p className="mb-4">
                                    Rest assured, every installation is performed by our certified technicians, who are skilled in both plumbing and
                                    electrical work.{" "}
                                </p>
                                <p className="mb-4">
                                    Their expertise ensures a smooth and professional process, and they&apos;ll be on hand to provide technical
                        ...
                        <div className="w-full md:w-1/3">
                            <Image
                                alt="delivery"
                                className="block object-cover w-full lg:max-h-[350px]"
                                src={"/support/installation.webp?v=1.1"}
                                width={500}
                                height={500}
                            />
                            <h4 className="text-[20px] font-bold text-black my-4 leading-[1.1] px-4 sm:px-0">Dust-Free Installation Process</h4>
                            <div className="text-[16px] text-black font-[Montserrat-Regular] leading-[1.2] px-4 sm:px-0">
                                <p className="mb-4">
                                    While the installation involves drilling a hole on your countertop, we take every precaution to ensure your
                                    kitchen stays clean and mess-free.{" "}
                                </p>
                                <p className="mb-4">
                                    Once the job is done, we&apos;ll leave your space spotless, so you can enjoy your new INTRIX One Tap without any
                                    hassle.
                                </p>
                            </div>
                        </div>
                        <div className="w-full md:w-1/3">
                            <Image
                                alt="delivery"
                                className="block object-cover w-full lg:max-h-[350px]"
                                src={"/support/manager.webp"}
                                width={500}
                                height={500}
                            />
                            <h4 className="text-[20px] font-bold text-black my-4 leading-[1.1] px-4 sm:px-0">Dedicated Relationship Manager</h4>
                            <div className="text-[16px] text-black font-[Montserrat-Regular] leading-[1.2] px-4 sm:px-0">
                                <p className="mb-4">
                                    Have questions or need assistance during installation? Our dedicated Relationship Manager is here to help.
                                </p>
                                <p className="mb-4">
                                    Professionally trained to address your concerns, they&apos;ll ensure all your queries are answered and any issues
                                    resolved. You can reach them at <Link href="tel:+60123671380">+60123671380</Link> or WhatsApp us for support.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <>
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-between gap-6 md:gap-8 my-12 md:my-24 container mx-auto px-4">
                        <div className="relative w-full md:w-2/5 md:pt-[150px]">
                            <h3 className="font-bold text-[20px] md:text-[30px] leading-[1.1] text-[#292929] md:absolute right-4 top-0 text-center md:text-left">
                                Returns &amp; Refunds Policy
                            </h3>
                            <Image
                                alt="transaction"
                                className="block max-w-[200px] md:mx-0 mx-auto my-6 md:my-0"
                                src={"/support/return.png"}
                                width={500}
                                height={500}
                            />
                        </div>
                    ...
                    <div className="flex md:flex-row flex-col items-start justify-between gap-6 md:gap-8 my-12 md:my-24 container mx-auto px-4 md:py-24 py-12 border-y border-[#421908]">
                        <div className="relative w-full md:w-2/5 md:pt-[150px]">
                            <h3 className="font-bold text-[20px] md:text-[30px] leading-[1.1] text-[#292929] md:absolute right-4 top-0 text-center md:text-left">
                                90-Day Tap Back Guaranteed
                            </h3>
                            <Image
                                alt="transaction"
                                className="block max-w-[200px] md:mx-0 mx-auto my-6 md:my-0"
                                src={"/support/tap_back.png"}
                                width={500}
                                height={500}
                            />
                        </div>
                ...
                <>
                    <div className="relative flex md:flex-row flex-col items-center justify-between gap-6 md:gap-24 pb-12 md:pb-24 container mx-auto px-4 lg:px-12 md:border-b border-[#421908]">
                        ...
                        <div className="relative w-full md:w-1/4">
                            <Image
                                alt="3 years shield"
                                className="block max-w-[200px] md:mx-0 mx-auto md:my-6 md:my-0"
                                src={"/support/shield.png"}
                                width={500}
                                height={500}
                            />
                        </div>
