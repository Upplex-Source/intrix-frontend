  ...
  return (
    ...
    <div className="bg-maintenance flex flex-col items-start gap-6 justify-start md:justify-between px-6 md:px-4 min-h-[1000px] md:min-h-[1000px]">
        ...
        <div className='container mx-auto'>
            ...
            <p className='font-[Montserrat-Regular] max-w-[650px] text-[#525456] text-[12px] md:text-[20px] mb-4'>We are currently upgrading our Intrix Lifestyle website to serve you better.</p>
