...
export async function generateMetadata() {
    return {
      ...
      openGraph: {
        title: "INTRIX One Tap – 4-IN-1",
        description: "RM5,200 · Instant hot water dispenser · ONE TAP series",
        url: "https://intrixlifestyle.com/product/intrix-one-tap-4-in-1",
        type: "website",
        images: [
          {
            url: "https://intrixlifestyle.com/product/facebook/tap-3.png",
            width: 1200,
            height: 630,
      ...
      twitter: {
        ...
        title: "INTRIX One Tap – 4-IN-1",
        description: "RM5,200 · Instant hot water dispenser · ONE TAP series",
        images: ["https://intrixlifestyle.com/product/facebook/tap-3.png"],
      },
    };
  }
