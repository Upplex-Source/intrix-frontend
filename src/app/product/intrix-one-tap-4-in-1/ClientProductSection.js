...
function Product() {
    ...
    const colorOptions = [
        ...
        },
        {
            ...
            name: "Gunmetal Grey",
            bgColor: "bg-gunmetal",
            modelSrc: "https://sketchfab.com/models/849153eea7564c7894a52239f7398598/embed?autostart=1&camera=0&preload=1&transparent=1",
        },
        {
            id: 2,
            name: "Matte Black",
            bgColor: "bg-black",
            modelSrc: "https://sketchfab.com/models/538670bb614f4006be0acaf3be87b58a/embed?autostart=1&camera=0&preload=1&transparent=1",
        },
        {
            id: 3,
            name: "Satin Gold",
            bgColor: "bg-satin",
            modelSrc: "https://sketchfab.com/models/8860c290b82442e78e80ab0c669fd73a/embed?autostart=1&camera=0&preload=1&transparent=1",
        },
    ];
                ...
                <div className="min-[1441px]:container mx-auto flex flex-wrap items-start justify-between relative">
                    ...
                    <div className="product-desc pt-4 md:pt-0 text-[#343637] w-full md:max-w-[400px] z-[3] px-4 bg-[#F6EFE2] md:pb-16 md:mt-0">
                      ...
                      <div className="grid grid-cols-2 gap-4 pb-1">
                        ...
                        <Link
                            href="/product/brochure/INTRIX One Tap 4-in-1.pdf"
                            target="_blank"
