...
export async function generateMetadata() {
    return {
      ...
      openGraph: {
        title: "INTRIX One Tap – 5-IN-1",
        description: "RM7,500 · Instant hot water dispenser · ONE TAP series",
        url: "https://intrixlifestyle.com/product/intrix-one-tap-5-in-1",
        type: "website",
        images: [
          {
            url: "https://intrixlifestyle.com/product/facebook/tap-1.png",
            width: 1200,
            height: 630,
      ...
      twitter: {
        ...
        title: "INTRIX One Tap – 5-IN-1",
        description: "RM7,500 · Instant hot water dispenser · ONE TAP series",
        images: ["https://intrixlifestyle.com/product/facebook/tap-1.png"],
      },
    };
  }
