...
function PaymentPlan() {
  let allTabs = [
    ...
    },
    {
      ...
      content: (
        <>
        <div className="text-center mx-auto mb-4 h-[75vh] sm:h-[850px] lg:h-[700px] min-[1441px]:h-[900px] payment_bg2 flex items-center">
          <div className="absolute top-0 w-[45vw] h-[700px] min-[1441px]:h-[900px] vertical_overlay_bg md:block hidden"></div>
          <div className="absolute top-0 w-[100vw] h-[40vh] overlay_bg md:hidden block"></div>
          <div className="absolute md:bottom-[unset] bottom-0 lg:top-[550px] min-[1441px]:top-[680px] w-[100vw] h-[50vh] sm:h-[300px] blur_skin_bg"></div>
          <div className="container mx-auto absolute px-4 left-0 right-0 md:top-[unset] top-[20px]">
            <h1 className="text-white text-[24px] md:text-[30px] xl:text-[40px] w-[280px] md:w-[450px] font-[Mulish-Regular] font-bold md:font-[Mulish-Black] text-left leading-[1.2]">Own your INTRIX One Tap with the Easy Payment Plan!</h1>
            <p className="text-white text-[20px] text-left leading-[1.2] md:w-[420px] mt-6 md:block hidden font-[Montserrat-Regular]">With the EPP, you are able to use your credit card to pay the instalment of your INTRIX One Tap with no upfront payment!*</p>
            <i className="text-white text-[12px] text-left leading-[1.2] mt-12 md:block hidden font-[Montserrat-Regular]">*processing fees apply</i>
          </div>
        </div>
        ...
        <div className="z-[2] relative mb-12 mt-6 px-4 border-b border-[#421908]">
        <SupportCards cards={cardData3} />
        </div>
        <div className="border-b border-[#421908] pb-12">
          <div className="container mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 xl:gap-12 items-center lg:px-4 mb-6">
            <div className="bg-[#F79932] px-4 py-6 rounded-[32px] text-black flex items-center flex-col leading-[1.2] h-fit">
              <h2 className="text-center font-bold text-[30px]">Example of EPP Monthly <br/>Instalment Breakdown:</h2>
              <p className="text-center text-[20px] mt-6 mb-4">If you&apos;re looking to buy an<br/> INTRIX One Tap 4-in-1 using EPP,</p>
              <p className="border-t border-[#000] flex items-center justify-between w-full py-2"><span>Outright price:</span><span>RM 5,200</span></p>
              <p className="border-t border-[#000] flex items-center justify-between w-full py-2"><span>Processing Fees:</span><span>RM 200</span></p>
              <p className="border-t border-[#000] flex items-center justify-between w-full py-2"><span>Tenure:</span><span>24 months</span></p>
              <p className="border-t border-[#000] flex items-center justify-between w-full py-2"><span>Total:</span><span>RM 5,400</span></p>
              <p className="pb-8 border-t border-[#000] flex items-center justify-between w-full py-2"><span>Monthly Payment:</span><span>RM 225 x 24 months</span></p>
            </div>
            <ParticipatingBanks />
          </div>
