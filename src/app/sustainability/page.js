  ...
  let allTabs = [
    {
      ...
      content: (
        ...
        <div className="container mx-auto mb-12 md:px-4">
          ...
          <h2 className="font-bold text-[#343637] mb-2 mt-4 md:mt-12 md:text-[30px] text-center">How Our EcoSmart Tech Helps You Save</h2>
        ...
        <div className="container mx-auto mb-6 px-4 flex flex-col md:flex-row gap-4">
            <div className="rounded-[30px] bg-[#F79932] flex items-center justify-center gap-4 md:gap-12 px-4 md:px-[4vw] py-6 md:py-[5vw] w-full md:w-1/2">
              <Image alt="save energy" className="block max-w-[70px] md:max-w-[120px]" src={'/sustainability/save_energy.png'} width={500} height={500} />
              <h3 className="font-[Montserrat-Bold] text-[20px] md:text-[30px] leading-[1.2]">Enjoy up to <b className="text-[#421908]">80&#37; energy saving</b> compared to an average electric kettle&#42;&#33;</h3>
            </div>
            <div className="md:p-6 w-full md:w-1/2 text-[#292929]">
              <p className="mb-6 text-[16px] xl:text-[20px]">The INTRIX One Tap consumes between 0.6 to 0.8 kWh per day on Eco Mode for a similar supply of hot water. This translates to RM0.23 to RM0.39 per day. On average, expect to save up to 80% of your monthly electricity costs for hot water!</p>
              <p className="italic text-[12px] xl:text-[14px]">*An average electric kettle for a family of 4 will consume approximately between 1.8 to 2 kWh per day to boil water, which is about RM0.64 to RM0.98 per day (depending on tariff category).</p>
            </div>
        </div>
        <div className="container mx-auto mb-6 px-4 flex flex-col md:flex-row-reverse items-center gap-4">
            <div className="rounded-[30px] bg-[#F79932] flex items-center justify-center gap-4 md:gap-8 px-4 md:px-[3vw] py-6 md:py-[4vw] w-full md:w-1/2">
              <Image alt="save energy" className="block max-w-[80px] md:max-w-[180px]" src={'/sustainability/recycle.png'} width={500} height={500} />
              <h3 className="font-[Montserrat-Bold] text-[20px] md:text-[30px] leading-[1.2]">Filter is crafted with <b className="text-[#421908]">95% recyclable materials</b> to allow for repurposing after use.</h3>
            </div>
            <div className="md:p-6 w-full md:w-1/2 text-[#292929]">
              <p className="mb-6 text-[16px] xl:text-[20px] md:text-right">The INTRIX All-In-One Filter is designed with <b className="font-[Montserrat-Bold]">95% recyclable materials</b>, allowing the components to be repurposed after use, ultimately reducing waste.</p>
            </div>
        </div>
        <div className="container mx-auto mb-6 px-4 flex flex-col md:flex-row gap-4">
            <div className="rounded-[30px] bg-[#F79932] flex items-center justify-center gap-6 px-4 md:px-[4vw] py-6 md:py-[5vw] w-full md:w-1/2">
              <Image alt="cost" className="block max-w-[80px] md:max-w-[150px]" src={'/sustainability/cost.png'} width={500} height={500} />
              <h3 className="font-[Montserrat-Bold] text-[20px] md:text-[30px] leading-[1.2]">Reduces <b className="text-[#421908]">overall cost by 75%</b> compared to other water purifier brands per year*!</h3>
            </div>
            <div className="md:p-6 w-full md:w-1/2 text-[#292929]">
              <p className="mb-6 text-[16px] xl:text-[20px]">Not only that, the All-In-One Filter only requires a <b className="font-[Montserrat-Bold]">one-time filter change</b> in a single year, compared to other water purifier brands which require up to
              four filter changes per year*.</p>
